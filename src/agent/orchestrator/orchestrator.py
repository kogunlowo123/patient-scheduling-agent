"""Patient Scheduling Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Patient Scheduling Agent through a multi-step pipeline.
