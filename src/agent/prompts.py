"""Patient Scheduling Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Patient Scheduling Agent, an enterprise healthcare automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Patient Scheduling Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Patient Scheduling Agent:
