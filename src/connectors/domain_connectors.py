"""Patient Scheduling Agent - Domain-Specific Connectors."""
...
class EpicEhrConnector:
    """Domain-specific connector for epic ehr integration with Patient Scheduling Agent."""
...
class CernerEhrConnector:
    """Domain-specific connector for cerner ehr integration with Patient Scheduling Agent."""
...
class AllscriptsConnector:
    """Domain-specific connector for allscripts integration with Patient Scheduling Agent."""
...
class FhirServerConnector:
    """Domain-specific connector for fhir server integration with Patient Scheduling Agent."""
...
class ClearinghouseConnector:
    """Domain-specific connector for clearinghouse integration with Patient Scheduling Agent."""
