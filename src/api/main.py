"""Patient Scheduling Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Patient scheduling agent that manages appointment bookings, optimizes provider schedules, handles cancellations and waitlists, sends appointment reminders, and reduces no-show rates.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
